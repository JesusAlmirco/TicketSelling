...
class ReservationCheckViewTest(TestCase):
    ...
    def test_response_for_post_method_with_reservation_id(self):
        ...
        e = Event.objects.create(name='TestEvent', description='TestDescription', datetime=timezone.now() + timedelta(days=2))
        r = Reservation.objects.create(status=Reservation.PAID, client=c, event=e)
    ...
    def test_response_for_post_method_without(self):
        ...
        # WHEN
        response = self.client.post(reverse('reservation:reservation_check'), {'reservation_id': '', 'email': 'test@email.com'})
    ...
    def test_response_for_post_method_without_valid_form(self):
        ...
        # WHEN
        response = self.client.post(reverse('reservation:reservation_check'), {'reservation_id': '', 'email': 'test@test.com'})
