...
def prepare_seats_rows(event):
    ...
    for ticket_type in ticket_types:
        ...
        ticket_types_data.append({
            'type': ticket_type['type__type'], 
            'price': ticket_type['type__price'],
            'tickets': ticket_data
        })
...
def choose_tickets_panel(request, event_pk):
    ...
    context ={
        ...
        'form': form, 
        'tickets': ticket_types_data
    }
    return render(request, 'reservation/buy_tickets.html', context)
...
def reservation_confirmation(request, reservation_pk):
    ...
    return render(request, 'reservation/reservation_confirmation.html', context)
